...
import 'package:flutter_application_1/presentation/Administrator/controllers/student_attandence_controller.dart';
...
class PerfectStudentAttendanceScreenadmin extends StatelessWidget {
  PerfectStudentAttendanceScreenadmin({Key? key}) : super(key: key);

  final controller = Get.put(StudentAttendanceControlleradmin());
