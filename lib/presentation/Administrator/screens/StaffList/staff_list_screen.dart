...
import 'package:flutter_application_1/presentation/Administrator/controllers/ModernStaffController.dart';
...
class ModernStaffScreenadmin extends StatelessWidget {
  ModernStaffScreenadmin({Key? key}) : super(key: key);

  final controller = Get.put(ModernStaffControlleradmin());
