...
import 'package:flutter_application_1/presentation/Administrator/controllers/staff_detail_controller.dart';
...
class StaffDashboardScreenadmin extends StatelessWidget {
  StaffDashboardScreenadmin({Key? key}) : super(key: key);

  final controller = Get.put(StaffDashboardControlleradmin());
