...
class EnhancedStaffAttendanceScreenadmin extends StatelessWidget {
  EnhancedStaffAttendanceScreenadmin({Key? key}) : super(key: key);

  final controller = Get.put(EnhancedStaffAttendanceControlleradmin());
