...
import 'package:flutter_application_1/presentation/Administrator/controllers/payment_controller.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';

import '../../widgets/payment_widgets.dart';

class NewPaymentScreenV4admin extends StatelessWidget {
  NewPaymentScreenV4admin({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(NewPaymentControllerV4admin());
  ...
  Widget _buildHeader(NewPaymentControllerV4admin controller, BuildContext context) {
    return Container(
  ...
  Widget _buildMonthSelector(
    NewPaymentControllerV4admin controller,
  ...
  Widget _buildStatsCards(NewPaymentControllerV4admin controller) {
    return Obx(
      () => Row(
        children: [
          Expanded(
  ...
  Widget _buildStudentsPanel(NewPaymentControllerV4admin controller) {
    return Container(
  ...
  Widget _buildPaymentPanel(NewPaymentControllerV4admin controller, BuildContext context) {
    return Obx(() {
  ...
  Widget _buildSelectedStudentCard(NewPaymentControllerV4admin controller) {
    return Obx(() {
  ...
  Widget _buildPaymentHistoryCard(NewPaymentControllerV4admin controller) {
    return Container(
      padding: EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildDebtsSection(NewPaymentControllerV4admin controller) {
    return Obx(() {
 ...
 Widget _buildPaymentDetailsCard(NewPaymentControllerV4admin controller, BuildContext context) {
    return Container(
      padding: EdgeInsets.all(20),
  ...
  Widget _buildSaveButton(NewPaymentControllerV4admin controller) {
    return Obx(
      () => SizedBox(
        width: double.infinity,
        height: 60,
