          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Chek raqami: ${paymentData['receipt_number'] ?? '-'}',
                  style: TextStyle(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.school_rounded, size: 60, color: primaryBlue),
                    ),
                    SizedBox(height: 16),
                    Text(
              ...
              if (studentData['class_level_name'] != null)
                _buildInfoRow('Daraja:', studentData['class_level_name']),
              if (studentData['teacher_name'] != null)
                _buildInfoRow('Sinf rahbari:', studentData['teacher_name']),
              ...
              _buildInfoRow('To\'lov usuli:', _getPaymentMethodText()),
              ...
              if ((paymentData['discount_amount'] ?? 0) > 0) ...[
                ...
                if (paymentData['discount_reason'] != null)
                  Padding(
                    ...
                    child: Text(
                      'Sabab: ${paymentData['discount_reason']}',
                      style: TextStyle(
                        fontSize: 12,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      '${_formatCurrency(paymentData['final_amount'])} so\'m',
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${_formatCurrency(paymentData['remaining_debt'])} so\'m',
                            style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: Colors.red[700],
              ...
              Center(
                child: Column(
                  children: [
                    Text(
                      'Rahmat! Muvaffaqiyatlar tilaymiz!',
                      style: TextStyle(
                        fontSize: 14,
                        fontStyle: FontStyle.italic,
                        color: Colors.grey[600],
                    ...
                    SizedBox(height: 8),
                    Text(
                      'Bu chek elektron shaklda yaratilgan',
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 40),
              pw.Text('JAMI TO\'LANDI: ${_formatCurrency(paymentData['final_amount'])} so\'m',
                style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
            ],
          );
        },
