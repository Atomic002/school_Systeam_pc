 ...
 Widget _buildStaffSalaries() {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // 2. YANGI STATISTIKA BLOKI (MUAMMO YECHIMI SHU YERDA)
                // Bu yerda Jami Hisoblangan, To'langan va eng muhimi QOLDIQ ko'rinadi
                Container(
                  ...
                  child: Row(
                    children: [
                      // Jami hisoblangan
                      Expanded(
                        child: _buildSalarySummaryItem(
                          'Jami Hisoblandi',
                          controller.totalSalaryPayable.value,
                          Colors.blue[700]!,
                        ),
                      ),
                      ...
                      Expanded(
                        child: _buildSalarySummaryItem(
                          'To\'landi',
                          controller.totalSalaryPaid.value,
                          Colors.green[700]!,
                        ),
                      ),
                      Container(width: 1, height: 40, color: Colors.grey[300]),
                      
                      // Jami Qarz (Siz so'ragan narsa)
                      Expanded(
                        child: _buildSalarySummaryItem(
                          'Jami Qarz (Qoldiq)',
                          controller.totalSalaryRemaining.value,
                          Colors.red[700]!,
                        ),
                      ),
                    ],
                ...
                // 3. XODIMLAR RO'YXATI
                if (controller.staffSalaryList.isEmpty)
                  Padding(
  ...
  // TEPADAGI STATISTIKA UCHUN YORDAMCHI WIDGET (Buni ham screen ichiga qo'shib qo'ying)
  Widget _buildSalarySummaryItem(String label, double amount, Color color) {
    return Column(
      children: [
        Text(
          label,
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 16, // Joyga sig'ishi uchun sal kichikroq qildim
            fontWeight: FontWeight.bold, 
            color: color
          ),
          textAlign: TextAlign.center,
